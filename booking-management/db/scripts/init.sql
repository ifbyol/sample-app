...
INSERT INTO bookings (user_id, room_id, number_of_guests, start_date, end_date) VALUES
    (1, 1, 2, '2024-01-15', '2024-01-18'),
    (2, 3, 4, '2024-02-01', '2024-02-05'),
    (3, 2, 1, '2024-01-20', '2024-01-22'),
    (4, 8, 5, '2024-03-10', '2024-03-15'),
    (5, 5, 2, '2024-02-14', '2024-02-16'),
    (6, 12, 6, '2024-04-01', '2024-04-07'),
    (7, 7, 1, '2024-01-25', '2024-01-27'),
    (8, 4, 3, '2024-02-20', '2024-02-25'),
    (9, 10, 2, '2024-03-05', '2024-03-08'),
    (10, 15, 4, '2024-05-01', '2024-05-05'),
    (11, 6, 3, '2024-02-10', '2024-02-13'),
    (12, 9, 2, '2024-03-20', '2024-03-23'),
    (13, 11, 2, '2024-04-15', '2024-04-18'),
    (14, 14, 1, '2024-01-30', '2024-02-02'),
    (15, 17, 2, '2024-06-01', '2024-06-03'),
    (1, 13, 2, '2024-07-10', '2024-07-12'),
    (2, 16, 1, '2024-03-01', '2024-03-03'),
    (3, 18, 2, '2024-05-15', '2024-05-17'),
    (4, 19, 7, '2024-08-01', '2024-08-10'),
    (5, 20, 2, '2024-04-20', '2024-04-22'),
    (6, 1, 3, '2024-09-01', '2024-09-05'),
    (7, 3, 4, '2024-06-15', '2024-06-20'),
    (8, 2, 1, '2024-07-25', '2024-07-28'),
    (9, 8, 6, '2024-10-01', '2024-10-07'),
    (10, 5, 2, '2024-11-10', '2024-11-12')
ON CONFLICT DO NOTHING;
